...
DomainErrorTranslator._directories = {
  ...
  'DELETE_COMMENT_USE_CASE.NOT_CONTAIN_COMMENT_ID': new InvariantError('harus mengirimkan commentId'),
  'DELETE_COMMENT_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('commentId harus string'),
  'REGISTER_REPLY.NOT_CONTAIN_NEEDED_PROPERTY': new InvariantError('tidak dapat membuat reply baru karena properti yang dibutuhkan tidak ada'),
  ...
  'DELETE_REPLY_USE_CASE.NOT_CONTAIN_REPLY_ID': new InvariantError('harus mengirimkan replyId'),
  'DELETE_REPLY_USE_CASE.PAYLOAD_NOT_MEET_DATA_TYPE_SPECIFICATION': new InvariantError('replyId harus string'),
